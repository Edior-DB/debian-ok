...
if [ ! -d "$HOME/.config/nvim" ]; then
  ...
  cp ~/.local/share/debian-ok/configs/neovim/transparency.lua ~/.config/nvim/plugin/after/

  # Default to Tokyo Night theme
  cp ~/.local/share/debian-ok/themes/tokyo-night/neovim.lua ~/.config/nvim/lua/plugins/theme.lua

  # Turn off animated scrolling
  cp ~/.local/share/debian-ok/configs/neovim/snacks-animated-scrolling-off.lua ~/.config/nvim/lua/plugins/
...
if [[ -d ~/.local/share/applications ]]; then
  ...
  source ~/.local/share/debian-ok/applications/Neovim.sh
fi
